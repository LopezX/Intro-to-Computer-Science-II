...
int main() {
    ...
    cout << "Testing writeObject....(Realize that this will not test your file format)" << endl;
    ofstream out("tempFile");
    a.writeObject(out);
    out.close();

    MyArray<int> c;
    cout << "Testing readObject...(Realize that this will not test your file format)" << endl;
